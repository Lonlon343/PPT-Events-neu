...
export function EventConfirmationEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>Deine Anmeldung für {eventTitle} ist bestätigt!</Preview>
      <Tailwind>
        <Body className="bg-gray-50 font-sans">
          <Container className="mx-auto py-12 px-6 max-w-xl">
            ...
            <Section className="bg-white rounded-b-2xl px-8 py-8 shadow-sm">
              <Text className="text-[#00325B] text-lg font-bold">
                Hallo {firstName}! 👋
              </Text>
              <Text className="text-zinc-600 leading-relaxed">
                Wir freuen uns, dich bei unserem Event begrüßen zu dürfen. Deine Anmeldung ist
                erfolgreich eingegangen. Hier sind deine Event-Details:
              </Text>
              ...
              <Text className="text-zinc-500 text-sm leading-relaxed">
                Falls du Fragen hast oder Änderungen benötigst, erreichst du uns jederzeit unter{' '}
